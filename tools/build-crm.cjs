...
const shell=['index.html','crm.css','crm.js','crm-model.js','crm-data.js','contacts.js','discovery.css','discovery-model.js','discovery.js','discovery-globe.js','grok-team.js','manifest.webmanifest','icon.svg'];
function assets(){
