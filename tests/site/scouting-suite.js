...
check('unified workspace loads visual dependencies in order and exposes honest preview/draft boundaries', () => {
  ...
  assert.deepEqual(scripts, ['./sample-data.js', './visual-data.js', './site-visuals.js', './energy-access-data.js', './site-access.js', './energy-preferences.js', './site-diligence.js', './locator-geography.js', './site-locator.js', './scouting.js']);
  assert.deepEqual(styles, ['./scouting.css', './site-access.css', './site-diligence.css', './site-locator.css']);
...
check('nested workspace assets participate in cache stamping and are mandatory publish outputs', () => {
  ...
  assert.deepEqual(stamping.expected(area).assets, ['./energy-access-data.js', './energy-preferences.js', './locator-geography.js', './sample-data.js', './scouting.css', './scouting.js', './site-access.css', './site-access.js', './site-diligence.css', './site-diligence.js', './site-locator.css', './site-locator.js', './site-visuals.js', './visual-data.js']);
  ...
  for (const file of ['index.html', 'sample-data.js', 'scouting.css', 'scouting.js', 'visual-data.js', 'site-visuals.js', 'energy-access-data.js', 'site-access.css', 'site-access.js', 'energy-preferences.js', 'site-diligence.js', 'site-diligence.css', 'locator-geography.js', 'site-locator.js', 'site-locator.css']) assert(required[1].includes("'portal/scouting/" + file + "'"), file + ' must be verified in the output');
});
