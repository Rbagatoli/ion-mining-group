...
(function (root, factory) {
    ...
    // New site-service IDs match intake. Historical offers remain valid as saved.
    var OFFERS = { custom_search: 'Custom Site Search', site_review: 'Existing Site Review', quote_review: 'Quote & Cost Review', research: 'Supplier Prospect Research', sourcing: 'Sourcing Desk', brief: 'Site Decision Brief', retainer: 'Ongoing service', managed_energy_hosting: 'Proton Managed Energy Hosting' };
