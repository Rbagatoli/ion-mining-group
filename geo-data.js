...
var GEO_DATA = {
    countries: [
        ...
        { code: 'ST', name: 'Sao Tome and Principe', lat: 0.19, lng: 6.61 },
    ...
    states: {
        'US': [
            { name: 'Alabama', lat: 32.32, lng: -86.90 },
            { name: 'Alaska', lat: 63.59, lng: -154.49 },
            { name: 'Arizona', lat: 34.05, lng: -111.09 },
            { name: 'Arkansas', lat: 35.20, lng: -91.83 },
            { name: 'California', lat: 36.78, lng: -119.42 },
            { name: 'Colorado', lat: 39.55, lng: -105.78 },
            { name: 'Connecticut', lat: 41.60, lng: -72.76 },
            { name: 'Delaware', lat: 38.91, lng: -75.53 },
            { name: 'District of Columbia', lat: 38.91, lng: -77.04 },
            { name: 'Florida', lat: 27.66, lng: -81.52 },
            { name: 'Georgia', lat: 32.17, lng: -82.91 },
            { name: 'Hawaii', lat: 19.90, lng: -155.58 },
            { name: 'Idaho', lat: 44.07, lng: -114.74 },
            { name: 'Illinois', lat: 40.63, lng: -89.40 },
            { name: 'Indiana', lat: 40.27, lng: -86.13 },
            { name: 'Iowa', lat: 41.88, lng: -93.10 },
            { name: 'Kansas', lat: 39.01, lng: -98.48 },
            { name: 'Kentucky', lat: 37.84, lng: -84.27 },
            { name: 'Louisiana', lat: 30.98, lng: -91.96 },
            { name: 'Maine', lat: 45.25, lng: -69.45 },
            { name: 'Maryland', lat: 39.05, lng: -76.64 },
            { name: 'Massachusetts', lat: 42.41, lng: -71.38 },
            { name: 'Michigan', lat: 44.31, lng: -85.60 },
            { name: 'Minnesota', lat: 46.73, lng: -94.69 },
            { name: 'Mississippi', lat: 32.35, lng: -89.40 },
            { name: 'Missouri', lat: 37.96, lng: -91.83 },
            { name: 'Montana', lat: 46.88, lng: -110.36 },
            { name: 'Nebraska', lat: 41.49, lng: -99.90 },
            { name: 'Nevada', lat: 38.80, lng: -116.42 },
            { name: 'New Hampshire', lat: 43.19, lng: -71.57 },
            { name: 'New Jersey', lat: 40.06, lng: -74.41 },
            { name: 'New Mexico', lat: 34.52, lng: -105.87 },
            { name: 'New York', lat: 43.30, lng: -74.22 },
            { name: 'North Carolina', lat: 35.76, lng: -79.02 },
            { name: 'North Dakota', lat: 47.55, lng: -101.00 },
            { name: 'Ohio', lat: 40.42, lng: -82.91 },
            { name: 'Oklahoma', lat: 35.47, lng: -97.52 },
            { name: 'Oregon', lat: 43.80, lng: -120.55 },
            { name: 'Pennsylvania', lat: 41.20, lng: -77.19 },
            { name: 'Rhode Island', lat: 41.58, lng: -71.48 },
            { name: 'South Carolina', lat: 33.84, lng: -81.16 },
            { name: 'South Dakota', lat: 43.97, lng: -99.90 },
            { name: 'Tennessee', lat: 35.52, lng: -86.58 },
            { name: 'Texas', lat: 31.97, lng: -99.90 },
            { name: 'Utah', lat: 39.32, lng: -111.09 },
            { name: 'Vermont', lat: 44.56, lng: -72.58 },
            { name: 'Virginia', lat: 37.43, lng: -78.66 },
            { name: 'Washington', lat: 47.75, lng: -120.74 },
            { name: 'West Virginia', lat: 38.60, lng: -80.45 },
            { name: 'Wisconsin', lat: 43.78, lng: -88.79 },
            { name: 'Wyoming', lat: 43.08, lng: -107.29 }
        ],
        'CA': [
            { name: 'Alberta', lat: 53.93, lng: -116.58 },
            { name: 'British Columbia', lat: 53.73, lng: -127.65 },
            { name: 'Manitoba', lat: 53.76, lng: -98.81 },
            { name: 'New Brunswick', lat: 46.57, lng: -66.46 },
            { name: 'Newfoundland and Labrador', lat: 53.14, lng: -57.66 },
            { name: 'Northwest Territories', lat: 64.83, lng: -124.85 },
            { name: 'Nova Scotia', lat: 44.68, lng: -63.74 },
            { name: 'Nunavut', lat: 70.30, lng: -83.11 },
            { name: 'Ontario', lat: 51.25, lng: -85.32 },
            { name: 'Prince Edward Island', lat: 46.51, lng: -63.42 },
            { name: 'Quebec', lat: 52.94, lng: -73.55 },
            { name: 'Saskatchewan', lat: 52.94, lng: -106.45 },
            { name: 'Yukon', lat: 64.28, lng: -135.00 }
        ],
        'AU': [
            { name: 'Australian Capital Territory', lat: -35.47, lng: 149.01 },
            { name: 'New South Wales', lat: -31.25, lng: 146.92 },
            { name: 'Northern Territory', lat: -19.49, lng: 132.55 },
            { name: 'Queensland', lat: -20.92, lng: 142.70 },
            { name: 'South Australia', lat: -30.00, lng: 136.21 },
            { name: 'Tasmania', lat: -41.45, lng: 145.97 },
            { name: 'Victoria', lat: -36.98, lng: 143.39 },
            { name: 'Western Australia', lat: -25.04, lng: 121.63 }
        ]
    },

    getCentroid: function(countryCode, stateName) {
        if (stateName && this.states[countryCode]) {
            var states = this.states[countryCode];
            for (var i = 0; i < states.length; i++) {
                if (states[i].name === stateName) {
                    return { lat: states[i].lat, lng: states[i].lng };
                }
            }
        }
        for (var j = 0; j < this.countries.length; j++) {
            if (this.countries[j].code === countryCode) {
                return { lat: this.countries[j].lat, lng: this.countries[j].lng };
            }
        }
        return null;
    },
    ...
    getCountryName: function(code) {
        for (var i = 0; i < this.countries.length; i++) {
            if (this.countries[i].code === code) return this.countries[i].name;
        }
        return code;
    }
};
