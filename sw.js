...
const CACHE_NAME = 'proton-mining-crm-confirmed-review-20260920';
const ASSETS = [
  './deal-qualification.js',
  './agent-control.html',
  './agent-control.css',
  './agent-control.js',
  './agent-control-model.js',
  './crm/outreach-model.js',
  './agent-control-store.js',
  './prospect-capital.js',
  './prospect-priority.js',
  './prospect-people.js',
  './prospect-capital.css',
  './prospect-ranking.js',
  './prospect-evidence.js',
  './prospect-evidence-ui.js',
  './prospect-evidence.css',
  // HTML pages
  './index.html',
  './calculator.html',
  './cycle.html',
  ...
  './owner-confirmation.js',
  './prospect-sourcing.js',
  './prospect-sourcing-ui.js',
  './prospect-sourcing.css',
  './data/sourcing-leads-2026-09-07.json',
  './owner-confirmation-ui.js',
  './owner-confirmation.css',
  ...
  './prospect-detail.js',
  './prospect-nav.js',
    './prospect-workspace.js',
    './prospect-workspace.css',
  './prospect-board.js',
