...
(function initWidgets() {
    ...
    var WIDGET_VERSION = 3; // Bump to reset saved order when HTML order changes
    ...
    // For banking page: scan ALL tabs, not just visible one, to preserve full widget list
