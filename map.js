...
function buildPieChart(currentA2) {
    ...
    return '<div style="padding-top:' + (pieMobile ? '6' : '10') + 'px;margin-top:' + (pieMobile ? '4' : '8') + 'px;border-top:1px solid ' + 'var(--line)' + ';">' +
        '<div style="font-size:' + (pieMobile ? '9' : '10') + 'px;color:' + 'var(--plat-500)' + ';text-transform:uppercase;letter-spacing:0.5px;margin-bottom:' + (pieMobile ? '4' : '6') + 'px;">Fleet Share</div>' +
...
function buildPopup(a2, data) {
    ...
    for (var mk = 0; mk < modelKeys.length; mk++) {
        modelHtml += '<div style="display:flex;justify-content:space-between;font-size:11px;color:' + 'var(--plat-400)' + ';padding:2px 0;">' +
            '<span>' + escapeHtml(modelKeys[mk]) + '</span><span style="color:' + 'var(--text)' + ';">' + data.models[modelKeys[mk]] + '</span></div>';
    }
    ...
    return '<div class="map-popup-container">' +
        ...
        '</div>' +
        (modelHtml ? '<div class="map-popup-models"><div style="font-size:10px;color:' + 'var(--plat-500)' + ';text-transform:uppercase;letter-spacing:0.5px;margin-bottom:4px;padding-top:8px;border-top:1px solid ' + 'var(--line)' + ';">Models</div>' + modelHtml + '</div>' : '') +
        buildPieChart(a2) +
    '</div>';
}
...
function buildStatePopup(loc) {
    ...
    for (var smk = 0; smk < smKeys.length; smk++) {
        stateModelHtml += '<div style="display:flex;justify-content:space-between;font-size:11px;color:' + 'var(--plat-400)' + ';padding:2px 0;">' +
            '<span>' + escapeHtml(smKeys[smk]) + '</span><span style="color:' + 'var(--text)' + ';">' + loc.models[smKeys[smk]] + '</span></div>';
    }
    ...
    return '<div class="map-popup-container">' +
        ...
        '</div>' +
        (stateModelHtml ? '<div class="map-popup-models"><div style="font-size:10px;color:' + 'var(--plat-500)' + ';text-transform:uppercase;letter-spacing:0.5px;margin-bottom:4px;padding-top:8px;border-top:1px solid ' + 'var(--line)' + ';">Models</div>' + stateModelHtml + '</div>' : '') +
    '</div>';
}
