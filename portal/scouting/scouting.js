...
(function () {
  ...
  document.getElementById('resetPreview').addEventListener('click', () => {
    ...
    state = { brief: { ...defaults }, feedback: {}, note: '', savedAt: null }; compared = []; showCompare = false; query = ''; status = 'all'; confirmedOnly = false; hideDismissed = false; selected = profiles[0].id; activeTab = 'access';
