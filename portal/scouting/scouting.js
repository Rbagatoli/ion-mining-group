...
(function () {
  ...
  function overview() {
    main.innerHTML = heading('YOUR NEXT CHAPTER', 'Good energy. A better starting point.', 'Landfill and stranded gas sourcing, with other energy options researched around your brief.', button('Edit my brief', 'brief')) +
