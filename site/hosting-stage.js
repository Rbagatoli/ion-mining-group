...
export function createStage(host, options = {}) {
    ...
    renderer.setPixelRatio(Math.min(Math.max(devicePixelRatio || 1,options.minPixelRatio || 1),options.maxPixelRatio || 1.6));
    renderer.outputColorSpace = T.SRGBColorSpace;
    renderer.toneMapping = T.ACESFilmicToneMapping; renderer.toneMappingExposure = options.exposure ?? 1.04;
